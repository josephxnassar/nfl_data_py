...
def test_train_ridge_regression_returns_model_and_score(sample_data):
    X, y = sample_data
...
def test_weights_are_computed_correctly(sample_data):
    X, y = sample_data
...
def test_calculate_rating_outputs_series(sample_data):
    X, y = sample_data
...
def test_get_ratings_adds_rating_column(sample_data):
    X, y = sample_data
